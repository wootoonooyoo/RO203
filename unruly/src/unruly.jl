...
Running this file
-----------------
cd("/Users/shawnliewhongwei/Desktop/JuliaTP/TP_Julia/unruly/src")
include("io.jl")
include("generation.jl")
include("unruly.jl")

[Eg usage]
cplexSolve(readInputFile("../data/board.txt"))
...
function recordInstance(filename::String = "../data/board.txt")
    ...
    filename_new = "../res/" * filename_split[3]
    println("Saving it in --- " * filename_new)
